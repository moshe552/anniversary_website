...
function generateNextMemoryWidget() {
    // Reset the header text to its original value
    document.querySelector('header h1').innerText = originalHeaderText;
...
window.addEventListener('DOMContentLoaded', () => {
  originalHeaderText = document.querySelector('header h1').innerText;
  generateNextMemoryWidget();
});
